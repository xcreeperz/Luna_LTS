...
urlpatterns = [
    ...
    path("acapp/apply_code/", acapp_apply_code, name="settings_acwing_web_apply_code"),
    path("acapp/receive_code/", acapp_receive_code, name="settings_acwing_web_receive_code"),
]